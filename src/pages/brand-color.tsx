        ...
        <>
            ...
            <main>
                ...
                <section className="light-theme">
                    <figure className="brand-light">
                        <div className="swatch"></div>
                        <figcaption>Brand</figcaption>
                    </figure>

                    <figure className="text1-light">
                        <div className="swatch"></div>
                        <figcaption>Text 1</figcaption>
                    </figure>

                    <figure className="text2-light">
                        <div className="swatch"></div>
                        <figcaption>Text 2</figcaption>
                    </figure>

                    <figure className="surface1-light">
                        <div className="swatch"></div>
                        <figcaption>Surface 1</figcaption>
                    </figure>

                    <figure className="surface2-light">
                        <div className="swatch"></div>
                        <figcaption>Surface 2</figcaption>
                    </figure>

                    <figure className="surface3-light">
                        <div className="swatch"></div>
                        <figcaption>Surface 3</figcaption>
                    </figure>

                    <figure className="surface4-light">
                        <div className="swatch"></div>
                        <figcaption>Surface 4</figcaption>
                    </figure>

                    <figure className="shadow-light">
                        <div className="swatch"></div>
